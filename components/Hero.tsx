...
export const Hero = () => {
    return (
        <section id="home" className="relative w-full h-screen">
            <Wallpaper />
            <div className="absolute z-20 top-1/2 -translate-y-1/2 left-[20%]">
                ...
                <p className="text-gray-300 max-w-md mb-10">
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Debitis rerum soluta
                    ipsum quas iste, voluptas eos maxime aliquid harum sint provident odit quidem
                    beatae pariatur optio vitae in similique a.
                </p>
